...
public class Solver {
    private static class SearchNode implements Comparable<SearchNode> {
        ...
        // a searchNode implementation based on MinPQ(Minimum Priority Queue)
    ...
    // everything we initiate a Solver class, it already gives a solution.
    public Solver(Board initial) {
        ...
        // if alternative board reach solution first, then it is unsolvable.
